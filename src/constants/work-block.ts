...
export const WORK_ITEMS: WorkBlock[] = [
  {
    name: 'Brand Strategy',
    descrp: 'Crafting unique brands with a distinct tone of voice, and visual identity.',
    experience: [
      {
        name: 'Huddle01',
        link: 'huddle01',
  ...
  },
  {
    ...
    descrp: 'Curating campaigns at the intersection of creativity and data driven growth.',
    experience: [
      {
  ...
  {
    name: 'Social Media',
    descrp: 'Creating the right mix of relatability, awareness and visual gratification',
    experience: [
